...
class TestGermanContent:
    ...
    def test_homepage_german(self, client):
        ...
        german_indicators = ['sicherheit', 'schutz', 'aktivist', 'privatsphäre', 'widerstand']
        assert any(word in data for word in german_indicators), "Homepage should contain German content"
